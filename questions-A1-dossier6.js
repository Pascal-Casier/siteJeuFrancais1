const questions = [
    // Saisons et météo (5 questions)
    {
        ...
        answer: 2,
        explanation: "L'hiver est la saison froide avec de la neige"
    },
    {
        question: "Quelle phrase décrit correctement l'été ?",
        options: [
            "Il fait froid et il pleut",
            "Les arbres perdent leurs feuilles",
            "Il fait chaud et il y a du soleil",
            "On porte des manteaux épais"
        ],
        answer: 2,
        explanation: "Caractéristiques typiques de l'été"
    },
    {
        question: "Complétez : Aujourd'hui, il ___ . (image de pluie)",
        options: ["fait soleil", "pleut", "neige", "vente"],
        answer: 1,
        explanation: "Il pleut = verbe impersonnel pour la pluie"
    },
    {
        question: "Trouvez l'intrus parmi les phénomènes météo :",
        options: ["la grêle", "le brouillard", "la bibliothèque", "l'orage"],
        answer: 2,
        explanation: "N'est pas un phénomène météorologique"
    },
    {
        question: "Complétez : En automne, les feuilles ___ .",
        options: ["tombent", "fleurissent", "gèlent", "verdissent"],
        answer: 0,
    ...
    // Dates et saisons (4 questions)
    {
        ...
        answer: 1,
        explanation: "Mois = préposition 'en'"
    },
    {
        question: "Transformez : '15/08' en français courant",
        options: [
            "Le quinze août",
            "Le quinze du huit",
            "Le quinzième août",
    ...
    },
    {
        ...
        options: ["à - y", "y - à", "en - y", "à - à"],
        answer: 0,
        explanation: "'Penser à' → remplacé par 'y'"
    },
    {
        question: "Trouvez l'erreur :",
        options: [
    ...
    // Loisirs (3 questions)
    {
        ...
        answer: 0,
        explanation: "'Loisirs' = activités de détente"
    },
    {
